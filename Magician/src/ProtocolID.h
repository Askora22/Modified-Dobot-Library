...
typedef enum {
    ...
    ProtocolDeviceID = ProtocolFunctionDeviceInfoBase + 5,
	...
	ProtocolClearAllAlarmsState = ProtocolFunctionALARMBase + 1,				// Added by Kevin Craker
    ...
    ProtocolLostStepDetection = ProtocolFunctionLostStepBase + 1,
    
    //Function Check ModelContect
    ProtocolFunctionCheckModelBase = 180,
    ProtocolFunctionCheckModel = ProtocolFunctionCheckModelBase + 1,
    ...
    ProtocolQueuedCmdFinish = ProtocolFunctionQueuedCmdBase + 8,
